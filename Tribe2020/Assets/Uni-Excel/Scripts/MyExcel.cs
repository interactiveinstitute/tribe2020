...
public class MyExcel : MonoBehaviour {
    ...
    void OnGUI() {
        ...
        FileStream MyAddress = 
			new FileStream(Application.dataPath + "/My First Excel.xls", FileMode.OpenOrCreate, FileAccess.ReadWrite, FileShare.ReadWrite);
        ...
        if (ReadExcelEnable_NPOI == true) {
            ...
            using (FileStream MyAddress_Read = 
				new FileStream(Application.dataPath + "/My First Excel.xls", FileMode.Open, FileAccess.Read, FileShare.ReadWrite)) {
